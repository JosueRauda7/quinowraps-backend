...
export class OpenAiService {
  ...
  async getRecipeSuggestion(ingredients: string[]): Promise<string> {
    ...
    const prompt = `Sugiere una receta que pueda hacerse con los siguientes ingredientes: ${ingredients.join(
      ...
      maxTokens
    } tokens o menos. Añade instrucciones breves de preparación. Distingue el nombre de la receta encerrandolo entre asteriscos. Que sea html la respuesta. La respuesta que sea lista para presentar en un div html (no agregues saltos de línea)`;
